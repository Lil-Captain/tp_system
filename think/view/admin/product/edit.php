    ...
    <div class="layui-card-body">
        <form class="layui-form" lay-filter="productForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="title" value="{$info.title|default=''}" required lay-verify="required" placeholder="请输入产品标题" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="content" id="content" placeholder="产品详情" class="layui-textarea" style="min-height: 300px;">{$info.content|default=''}</textarea>
                </div>
            </div>
...
layui.use(['form', 'upload', 'layer', 'jquery'], function(){
    ...
    form.on('submit(submitBtn)', function(data){
        ...
        $.post('/admin/product/edit?id=' + data.field.id, data.field, function(res){
            if(res.code == 0){
