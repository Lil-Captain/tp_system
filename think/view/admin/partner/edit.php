...
<div class="layui-card">
    <div class="layui-card-header">编辑合作伙伴</div>
        ...
        <form class="layui-form" lay-filter="partnerForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" value="{$info.name|default=''}" required lay-verify="required" placeholder="请输入名称" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="logo" id="logo" value="{$info.logo|default=''}" placeholder="Logo地址" class="layui-input">
                    ...
                    <div id="logoPreview" style="margin-top: 10px;">
                        ...
                        <img src="{$info.logo}" style="max-width: 300px; max-height: 200px;" />
                        {/if}
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="link" value="{$info.link|default=''}" placeholder="合作伙伴网站链接（可选）" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="description" placeholder="合作伙伴描述" class="layui-textarea">{$info.description|default=''}</textarea>
                </div>
            </div>
...
layui.use(['form', 'upload', 'layer', 'jquery'], function(){
    ...
    form.on('submit(submitBtn)', function(data){
        $.post('/admin/partner/edit?id=' + data.field.id, data.field, function(res){
            if(res.code == 0){
