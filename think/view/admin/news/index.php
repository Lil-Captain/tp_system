...
<div class="layui-card">
    <div class="layui-card-header">
        <span>新闻列表</span>
        <a href="/admin/news/add" class="layui-btn layui-btn-sm" style="float: right;">添加新闻</a>
    </div>
        ...
        <form class="layui-form" style="margin-bottom: 15px;">
            <div class="layui-row layui-col-space10">
                ...
                <div class="layui-col-md2">
                    ...
                    <a href="/admin/news/index" class="layui-btn layui-btn-primary">重置</a>
                </div>
            </div>
        </form>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="layui-btn layui-btn-danger layui-btn-xs" onclick="deleteNews({$vo.id})">删除</button>
                    </td>
                </tr>
                {/volist}
                {empty name="list"}
