    ...
    <div class="layui-card-body">
        <form class="layui-form" lay-filter="newsForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="category_id" lay-verify="required">
                        ...
                        <option value="{$vo.id}" {if condition="$vo.id == $info.category_id"}selected{/if}>{$vo.name}</option>
                        {/volist}
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="title" value="{$info.title|default=''}" required lay-verify="required" placeholder="请输入新闻标题" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="summary" placeholder="新闻摘要" class="layui-textarea">{$info.summary|default=''}</textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="content" id="content" placeholder="新闻内容" class="layui-textarea" style="min-height: 300px;">{$info.content|default=''}</textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="status" value="1" title="发布" {if condition="$info.status == 1"}checked{/if}>
                    <input type="radio" name="status" value="0" title="草稿" {if condition="$info.status == 0"}checked{/if}>
                </div>
            </div>
...
layui.use(['form', 'upload', 'layer', 'jquery'], function(){
    ...
    form.on('submit(submitBtn)', function(data){
        ...
        $.post('/admin/news/edit?id=' + data.field.id, data.field, function(res){
            if(res.code == 0){
