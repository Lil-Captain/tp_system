...
{block name="title"}添加解决方案{/block}

{block name="content"}
<div class="layui-card">
    <div class="layui-card-header">添加解决方案</div>
    <div class="layui-card-body">
        <form class="layui-form" lay-filter="solutionForm">
            <div class="layui-form-item">
                <label class="layui-form-label">方案标题</label>
                <div class="layui-input-block">
                    <input type="text" name="title" required lay-verify="required" placeholder="请输入方案标题" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="content" id="content" placeholder="方案详情" class="layui-textarea" style="min-height: 300px;"></textarea>
                </div>
            </div>
...
layui.use(['form', 'upload', 'layer', 'jquery'], function(){
    ...
    form.on('submit(submitBtn)', function(data){
        ...
        $.post('/admin/solution/add', data.field, function(res){
            if(res.code == 0){
