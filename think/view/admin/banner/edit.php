    ...
    <div class="layui-card-body">
        <form class="layui-form" lay-filter="bannerForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="image" id="image" value="{$info.image|default=''}" placeholder="图片地址" class="layui-input" required>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="link" value="{$info.link|default=''}" placeholder="点击跳转的链接（可选）" class="layui-input">
                </div>
            </div>
...
layui.use(['form', 'upload', 'layer', 'jquery'], function(){
    ...
    form.on('submit(submitBtn)', function(data){
        $.post('/admin/banner/edit?id=' + data.field.id, data.field, function(res){
            if(res.code == 0){
